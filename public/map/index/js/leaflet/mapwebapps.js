...
function layerControl(treeTypes){
	...
	var url = "http://3dmap.skyimin.com:8082/geoserver/xatree/wms?cql_filter=TreeType%20IN%20(" + treeTypes + ")";
...
function getTreeInfo(x,y){
	...
	var url = "http://3dmap.skyimin.com:8082/geoserver/xatree/wms?VERSION=1.0.0&LAYER=xatree:treelocation&STYLE=&TILEMATRIX=EPSG:4326:" + zoom + "&TILEMATRIXSET=EPSG:4326&SERVICE=WMTS&FORMAT=image/png&SERVICE=WMTS&REQUEST=GetFeatureInfo&INFOFORMAT=application/json&TileCol=" + col + "&TileRow=" + row + "&I=" + colp + "&J=" + rowp;
